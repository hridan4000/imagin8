...
document.addEventListener("DOMContentLoaded", function () {
  ...
  gsap.from(".about-text", {
    ...
    opacity: 0, // Start with 0 opacity for a fade-in effect
    duration: 1.5, // Duration for a smooth animation
    ease: "power2.out", // Smooth ease-out effect
    scrollTrigger: {
      trigger: ".about-section", // Trigger the animation when the .about-section comes into view
      start: "top 80%", // Start the animation when the top of the about-section reaches 80% of the viewport
      toggleActions: "play none none none", // Only play once on scroll
    },
  });

  // Slide about-img from the left on scroll
  gsap.from(".about-img", {
